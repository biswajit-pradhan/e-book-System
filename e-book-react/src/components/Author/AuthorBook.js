...
export class AuthorBook extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        this.props.allBooksOnRent(localStorage.getItem('userName'));
    }
    render() {
        return (
            <div>
...
export default connect(mapStateToProps, {allBooksOnRent})(AuthorBook);